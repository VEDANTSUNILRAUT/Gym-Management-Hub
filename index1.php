...
<body>
    <header class="header">
        ...
        <div class="right">
            <!-- <button class="btn"><a href="registration.php"></a></button>
    ...
    <div class="container">
        <div class="divbtn1">
            <button id="btn1"><a href="adashboard.php" style="color: #000; text-decoration: none;">Admin</a></button>
            <button class="btn2"><a href="udashboard.php" style="color: #000; text-decoration: none;"class="downCV">User</a></button>
        </div>
    </div>
</body>
